  ...
  return (
    <main className="w-full flex flex-col items-center px-6 py-10 bg-gray-100 min-h-screen">
      ...
      <section className="w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-white border border-gray-200 shadow-md rounded-lg p-6 flex flex-col items-center space-y-3">
          <img
            src={felipe}
            alt="felipe"
            className="w-32 h-32 object-cover rounded-full border border-gray-300"
          />
          <p className="text-gray-800 font-medium">Nome: Felipe Furlanetto</p>
          <p className="text-gray-700">RM: 562766</p>
          <p className="text-gray-700">Turma: 1TDSPF</p>
        ...
        <div className="bg-white border border-gray-200 shadow-md rounded-lg p-6 flex flex-col items-center space-y-3">
          ...
          <p className="text-gray-700">RM: 564115</p>
          <p className="text-gray-700">Turma: 1TDSPF</p>
          <div className="flex gap-4 pt-2">
            <a
        ...
        <div className="bg-white border border-gray-200 shadow-md rounded-lg p-6 flex flex-col items-center space-y-3">
          ...
          <p className="text-gray-700">RM: 562074</p>
          <p className="text-gray-700">Turma: 1TDSPF</p>
          <div className="flex gap-4 pt-2">
            <a
